...
<tbody>
  ...
  <tr>
    <td className="tg-0pky">Mathematics</td>
    ...
    <td className="tg-0pky">{checkGrade(result[2][2])}</td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky">{checkRemark(result[2][2])}</td>
    <td className="tg-0pky" colSpan="2">Regularity</td>
    <td className="tg-0pky" colSpan="2"></td>
  </tr>
  <tr>
    <td className="tg-0pky">English Language</td>
    ...
    <td className="tg-0pky">{checkGrade(result[3][2])}</td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky">{checkRemark(result[3][2])}</td>
    <td className="tg-0pky" colSpan="2">Punctuality</td>
    <td className="tg-0pky" colSpan="2"></td>
  </tr>
  <tr>
    <td className="tg-0pky">Igbo Language</td>
    ...
    <td className="tg-0pky">{checkGrade(result[4][2])}</td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky">{checkRemark(result[4][2])}</td>
    <td className="tg-0pky" colSpan="2">Assignment</td>
    <td className="tg-0pky" colSpan="2"></td>
  </tr>
  <tr>
    <td className="tg-0pky">Civic</td>
    ...
    <td className="tg-0pky">{checkGrade(result[5][2])}</td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky">{checkRemark(result[5][2])}</td>
    <td className="tg-0pky" colSpan="2">Self Control</td>
    <td className="tg-0pky" colSpan="2"></td>
  </tr>
  <tr>
    <td className="tg-0pky">Biology</td>
    ...
    <td className="tg-0pky">{checkGrade(result[6][2])}</td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky">{checkRemark(result[6][2])}</td>
    <td className="tg-0pky" colSpan="2">Leadership</td>
    <td className="tg-0pky" colSpan="2"></td>
  </tr>
  <tr>
    <td className="tg-0pky">Geography</td>
    ...
    <td className="tg-0pky">{checkGrade(result[7][2])}</td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky">{checkRemark(result[7][2])}</td>
    <td className="tg-0pky" colSpan="2">Obedience</td>
    <td className="tg-0pky" colSpan="2"></td>
  </tr>
  <tr>
    <td className="tg-0pky">Computer Studies</td>
    ...
    <td className="tg-0pky">{checkGrade(result[8][2])}</td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky">{checkRemark(result[8][2])}</td>
    <td className="tg-0pky" colSpan="2">Honesty</td>
    <td className="tg-0pky" colSpan="2"></td>
  </tr>
  <tr>
    <td className="tg-0pky">Agric Science</td>
    ...
    <td className="tg-0pky">{checkGrade(result[9][2])}</td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky">{checkRemark(result[9][2])}</td>
    <td className="tg-0pky" colSpan="2">Industry</td>
    <td className="tg-0pky" colSpan="2"></td>
  </tr>
  <tr>
    <td className="tg-0pky">C.R.S</td>
    ...
    <td className="tg-0pky">{checkGrade(result[10][2])}</td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky">{checkRemark(result[10][2])}</td>
    <td className="tg-0pky" colSpan="2">Neatness</td>
    <td className="tg-0pky" colSpan="2"></td>
  </tr>
  <tr>
    <td className="tg-0pky">Physics</td>
    ...
    <td className="tg-0pky">{checkGrade(result[11][2])}</td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky">{checkRemark(result[11][2])}</td>
    <td className="tg-0pky" colSpan="2">Rela. with others</td>
    <td className="tg-0pky" colSpan="2"></td>
  </tr>
  <tr>
    <td className="tg-0pky">Chemistry</td>
    ...
    <td className="tg-0pky">{checkGrade(result[12][2])}</td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky">{checkRemark(result[12][2])}</td>
    <td className="tg-0pky" colSpan="2">Class Participation</td>
    <td className="tg-0pky" colSpan="2"></td>
  </tr>
  <tr>
    <td className="tg-0pky">Further Maths</td>
    ...
    <td className="tg-0pky">{checkGrade(result[13][2])}</td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky">{checkRemark(result[13][2])}</td>
    <td className="tg-0pky" colSpan="2">Initiative</td>
    <td className="tg-0pky" colSpan="2"></td>
  </tr>
  <tr>
    <td className="tg-0pky">Government</td>
    ...
    <td className="tg-0pky">{checkGrade(result[14][2])}</td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky">{checkRemark(result[14][2])}</td>
    <td className="tg-0pky" colSpan="2">Games/Sports</td>
    <td className="tg-0pky" colSpan="2"></td>
  </tr>
  <tr>
    <td className="tg-0pky">Economics</td>
    ...
    <td className="tg-0pky">{checkGrade(result[15][2])}</td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky">{checkRemark(result[15][2])}</td>
    <td className="tg-0pky" colSpan="2"></td>
    <td className="tg-0pky" colSpan="2"></td>
  </tr>
  <tr>
    <td className="tg-0pky">Literature</td>
    ...
    <td className="tg-0pky">{checkGrade(result[16][2])}</td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky">{checkRemark(result[16][2])}</td>
    <td className="tg-0pky" colSpan="2"></td>
    <td className="tg-0pky" colSpan="2"></td>
  </tr>
  <tr>
    <td className="tg-0pky">Marketing</td>
    ...
    <td className="tg-0pky">{checkGrade(result[17][2])}</td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky">{checkRemark(result[17][2])}</td>
    <td className="tg-0pky" colSpan="2"></td>
    <td className="tg-0pky" colSpan="2"></td>
  </tr>
  <tr>
    <td className="tg-0pky">Animal Husbandry</td>
    ...
    <td className="tg-0pky">{checkGrade(result[18][2])}</td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky">{checkRemark(result[18][2])}</td>
    <td className="tg-0pky" colSpan="2"></td>
    <td className="tg-0pky" colSpan="2"></td>
  </tr>
  <tr>
    <td className="tg-0pky">Data Processing</td>
    ...
    <td className="tg-0pky">{checkGrade(result[19][2])}</td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky"></td>
    <td className="tg-0pky">{checkRemark(result[19][2])}</td>
    <td className="tg-0pky" colSpan="2"></td>
    <td className="tg-0pky" colSpan="2"></td>
  </tr>
...
function checkResultGrade(score){
  if ((score >= 90) & (score <=100)){
    return  "Outstanding"
    }
    else if(score >= 75){
